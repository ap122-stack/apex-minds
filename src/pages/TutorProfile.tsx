...
const TUTORS: Record<string, { id: string; name: string; subjects: string[]; rate: number; rating: number; sessions: number; bio: string; photo: string; longBio: string }> = {
  stem: { id: 'stem', name: 'Alex Chen', subjects: ['AP Calculus', 'AP Physics', 'SAT Math'], rate: 75, rating: 5.0, sessions: 28, photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&q=80&auto=format&fit=crop', bio: 'MIT grad specializing in STEM fundamentals and AP exam mastery.', longBio: 'Alex graduated with honors from MIT in Applied Mathematics. He has helped over 28 students achieve A+ grades in AP Calculus and Physics, and consistently improves SAT Math scores by 100+ points within 8 weeks. His method focuses on concept clarity over memorization.' },
  humanities: { id: 'humanities', name: 'Maya Johnson', subjects: ['AP English', 'College Essays', 'Writing'], rate: 70, rating: 5.0, sessions: 22, photo: 'https://images.unsplash.com/photo-1494790108755-2616b612b5bc?w=800&q=80&auto=format&fit=crop', bio: 'Yale English grad with a 100% college admissions essay success rate.', longBio: 'Maya earned her English degree from Yale and spent 3 years tutoring high-achieving students across the northeast. Every student she has coached on college essays has received at least one acceptance from their first-choice school.' },
  testprep: { id: 'testprep', name: 'Jordan Park', subjects: ['SAT', 'ACT', 'PSAT'], rate: 80, rating: 5.0, sessions: 31, photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=800&q=80&auto=format&fit=crop', bio: 'Perfect SAT scorer helping students crack the 1500+ barrier.', longBio: 'Jordan scored a perfect 1600 on the SAT and a 36 on the ACT. He teaches a proprietary method that isolates your weakest question types and builds targeted strategies. Average score improvement after 8 sessions: +180 points.' },
  admissions: { id: 'admissions', name: 'Dr. Sarah Lee', subjects: ['College Admissions', 'Common App', 'Interview Prep'], rate: 120, rating: 5.0, sessions: 19, photo: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=800&q=80&auto=format&fit=crop', bio: 'Former admissions officer from Stanford with insider knowledge.', longBio: 'Dr. Lee spent 7 years as a Senior Admissions Officer at Stanford University before founding her private consulting practice. She knows exactly what top schools look for and crafts application narratives that stand out from thousands of applicants.' },
}
        ...
        <div className="ed-section-inner" style={{ maxWidth: '800px' }}>
          ...
          <div style={{ display: 'flex', gap: '32px', flexWrap: 'wrap', marginBottom: '40px' }}>
            ...
            <div style={{ flex: 1, minWidth: '240px' }}>
              ...
              <div style={{ fontFamily: 'var(--font-display)', fontSize: '24px', fontWeight: 700, color: 'var(--apex-plum)', marginBottom: '20px' }}>
                ${tutor.rate}<span style={{ fontFamily: 'var(--font-body)', fontSize: '14px', fontWeight: 400, color: 'var(--slate)' }}>/hr</span>
              </div>
